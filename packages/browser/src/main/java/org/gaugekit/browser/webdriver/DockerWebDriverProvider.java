...
/**
 * {@link WebDriverProvider} relying on <a href="https://www.testcontainers.org/">Testcontainers</a>'
 * {@link BrowserWebDriverContainer} to run browsers on a local Docker infrastructure.
 */
public class DockerWebDriverProvider extends WebDriverProvider {
     ...
     */
    public DockerWebDriverProvider(BrowserType browserType, Capabilities additionalCapabilities) {
     ...
     * @param browserType the {@link BrowserType} to be setup
     */
    public DockerWebDriverProvider(BrowserType browserType) {
