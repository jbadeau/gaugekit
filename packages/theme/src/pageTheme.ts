...
export const pageTheme: Record<string, PageTheme> = {
  home: genPageTheme(colorVariants.default, shapes.round),
  documentation: genPageTheme(colorVariants.default, shapes.round),
  tool: genPageTheme(colorVariants.default, shapes.round),
  service: genPageTheme(colorVariants.default, shapes.round),
  website: genPageTheme(colorVariants.default, shapes.round),
  library: genPageTheme(colorVariants.default, shapes.round),
  other: genPageTheme(colorVariants.default, shapes.round),
  app: genPageTheme(colorVariants.default, shapes.round),
  apis: genPageTheme(colorVariants.default, shapes.round),
};
