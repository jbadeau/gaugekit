 ...
 */
public class RemoteWebDriverSupplier extends WebDriverSupplier {
     ...
     */
    public RemoteWebDriverSupplier(BrowserType browserType, Capabilities additionalCapabilities) {
     ...
     * @param browserType the {@link BrowserType} to be setup
     */
    public RemoteWebDriverSupplier(BrowserType browserType) {
